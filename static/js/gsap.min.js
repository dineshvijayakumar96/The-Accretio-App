    ...
    Rt =
      ...
      (g = {
        ...
        remove: function remove(t, e) {
          ~(e = B.indexOf(t)) && B.splice(e, 1) && e <= k && k--;
        },
        _listeners: (B = []),
      })),
    Ft = function _wake() {
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            for (a in i)
              pt[a] && (f = ac(a, i, t, d, o, E))
                ? f.priority && (u = 1)
                : (c[a] = s =
                    Qt.call(t, o, a, "get", i[a], d, E, 0, m.stringFilter));
        ...
        if (p) {
          if (
            ...
            if (!this._initted) {
              ...
              if (
                !(c === this._time || (r && this.vars.repeatRefresh && a !== o))
              )
                return this;
            ...
            if (
              ...
              i && !c && !e && !a && (Ct(this, "onStart"), this._tTime !== m))
            )
              return this;
  ...
  function Ld() {
    ...
    if (this.tfm) {
      ...
      a.svg &&
        ...
        ((t = Be()) && t.isStart) || n[dr] || (Kd(n), (a.uncache = 1));
    }
  }
  function Md(t, e) {
  ...
  var De,
    ...
    Sr = function _renderCSSTransforms(t, e) {
      ...
      _ !== Cr && (y += "perspective(" + _ + Ar),
        ...
        h !== Pr && (y += "rotateY(" + h + Ar),
        l !== Pr && (y += "rotateX(" + l + Ar),
        (f === Pr && c === Pr) || (y += "skew(" + f + ", " + c + Ar),
        (1 === d && 1 === p) || (y += "scale(" + d + ", " + p + Ar),
